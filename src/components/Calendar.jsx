                    ...
                    <div className="hidden md:flex items-center gap-2 text-sm font-medium">
                        ...
                        <div className="relative group">
                            <button 
                                ...
                                className={`px-3 py-1.5 text-[#a3a3a3] hover:text-white transition-colors flex items-center gap-1.5 rounded-md ${isMoreOpen ? 'bg-[#2a2a2a] text-white shadow-sm' : 'hover:bg-[#1a1a1a]'}`}
                            >
                                More
